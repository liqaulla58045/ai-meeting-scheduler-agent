...
def main():
    ...
    st.write("Natural-language based meeting scheduler powered by an offline NLP engine.")
    ...
    with tab1:
        ...
        st.caption(
            "Example: *Schedule a 30-minute sync with Rahul tomorrow at 3 PM about project review*"
        )
